        ...
        <v-col cols="6">
          <v-list class="mx-auto">
            <v-list-item>
              <v-col cols="1"></v-col>
              <v-col cols="6">
                <header class="headline ml-n4">Foto del ejercicio:</header>
              </v-col>
            </v-list-item>
            ...
            <div v-if="hasPic">
              <v-list-item>
                <v-img :src="url" class="ml-7 mt-n4"
                       height="250"
                       width="400"/>
              </v-list-item>
            </div>
            ...
            <v-list-item class="mb-n6">
              <v-row class="ml-8 my-n2">
                <v-col cols="1"></v-col>
                <v-col cols="8">
                  <v-text-field label="Ingrese el link de la imagen" id="url_id"></v-text-field>
                </v-col>
...
export default {
  ...
  methods: {
    ...
    async cancelExercise() {
      if(this.id === null || !this.exerciseCreatedFlag)
        this.router.back();
      else {
        await this.store.deleteExercise(this.id);
        this.exerciseCreatedFlag = false;
        this.router.back();
      }
    },
